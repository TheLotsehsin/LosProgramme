...
<head>
  ...
  <title>登录页面</title>
  <!--引入BootStrap样式-->
  <link href="statics/css/zui/css/zui.min.css" rel="stylesheet">
  <link href="statics/css/zui/lib/uploader/zui.uploader.min.css" rel="stylesheet">
  <style>
    body {
      background: url("statics/images/4.jpg") no-repeat center fixed;
    }
    ...
    <div class="col-sm-6 col-sm-offset-3 col-md-4 col-sm-offset-4 login-box">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane fade in active" id="account-login">
          <form id="normal_form" name="form" role="form" class="login-form" action="${pageContext.request.contextPath}/user/login" method="post">
            ...
            <div class="form-group">
              ...
              <input type="password" id="password" name="upwd"   value="${password}" class="form-control" placeholder="密码">
            </div>
            ...
            <div class="form-group">
&lt;%&ndash;              <input type="submit" value="提交"></input>&ndash;%&gt;
...
<script src="statics/VUE/jquery-3.2.1.min.js"></script>
<script src="statics/css/zui/js/zui.min.js"></script>
...
<html>
  ...
  <form action="${pageContext.request.contextPath}/user/login" method="post">
    用户名：<input type="text" width="50" name="userName"></br>
    密码:<input type="password" width="50" name="upwd"></br>
